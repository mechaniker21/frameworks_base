...
public class FloatingWindowsTile extends QSTile<QSTile.BooleanState> {
    ...
    public void handleLongClick() {
        final String ROMCONTROL_PACKAGE_NAME = "com.aokp.romcontrol";
        Intent INTENT_ROMCONTROL = new Intent(Intent.ACTION_MAIN)
                .setClassName(ROMCONTROL_PACKAGE_NAME, ROMCONTROL_PACKAGE_NAME
                + ".fragments.general.FloatingWindows");
        mHost.startActivityDismissingKeyguard(INTENT_ROMCONTROL);
    }
 ...
 protected void toggleState() {
    ...
    public int getMetricsCategory() {
        return CMMetricsLogger.ROMCONTROL;
    }
}
